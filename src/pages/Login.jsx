...
const Login = () => {
  ...
  return (
    <div className='md:mt-10 mt-16 text-center'>
      <label className='font-bold md:text-4xl text-3xl'> Hello</label>
      <p className='mt-1 font-normal'>Sign in to Clothes Z or <a className='underline text-[rgb(91,153,255,0.8)]' href="/signup">create an account</a></p>
